...
2. Go to **Settings** → **Network Adapter** and open the **Security** tab.
   ...
   <div class="screenshot-frame"><img src={certSecurityTab.src} alt="Security tab: current certificate info and custom certificate upload form" /></div>
...
:::tip
To return to the device's built-in self-signed certificate at any time, open the same **Security** tab and click **Zurücksetzen** next to the **Aktuelles Zertifikat** heading — this removes the uploaded certificate.
:::
