...
An update bundle can cover several functions and areas of an Edge. Each package builds on the previous one. It is therefore important to install update packages one after another and in the correct order.
...
2. Open the Edge AdvancedUI (accessible under "Advanced Settings").

3. Navigate to "System" > "Settings" > "System Control".

4. Under "Update", click the button. A new tab opens with the update area.

5. Make sure the current version of the Edge is the direct predecessor of the update bundle.
