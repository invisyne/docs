...
description: "The WebUI (Web User Interface) is the browser-based interface of the Edge device."
---

The WebUI (Web User Interface) is the browser-based interface of the Edge device.
