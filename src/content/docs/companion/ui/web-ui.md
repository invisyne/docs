...
- **Direct access to configuration:** The Crawler.Companion offers a button (e.g., a globe or browser icon) through which the customer can launch the WebUI (Web User Interface) of the selected Edge device directly from the application.
