...
- **Check software version:** The customer immediately sees which software version is currently installed on the Edge (Crawler) device and can determine whether a newer version is available.
...
- **Start update:** With a click on "Install update," the process begins. This allows the customer to keep the Edge (Crawler) devices up to date quickly and securely (important for security and new features).
