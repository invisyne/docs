...
The Crawler.Companion is a specialized Windows application (desktop software) that serves as a central local management tool for your Edge (Crawler) devices. It is an essential component of the Edge (Crawler) platform (consisting of Edge, Hub, and Companion) and was specifically developed for technicians and administrators who need to perform configuration and maintenance tasks directly on-site in the local network (LAN).

### **Core Functionality and Differentiation:**

| Function           | Description                                                                         | Benefit for the User                                                                         |
| ------------------ | ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Network Discovery  | Automatic search and listing of all Edge (Crawler) devices in the same local network. | Quick finding and identification of devices without manual IP entry.                         |
...
| Updates            | Installation of firmware and software updates on the Edge (Crawler) devices.                  | Ensures that devices always operate with the latest, most secure, and feature-rich software. |
...
- **Purpose:** To find, access, and configure an Edge (Crawler) device that collects, processes, and forwards data.
- **Requirement:** PC must be on the same network as the Edge (Crawler).

### **Core Tasks:** 

:::Paragraph{listStyleType="disc" indent="2"}
Automatically find device (Edge (Crawler))
:::
