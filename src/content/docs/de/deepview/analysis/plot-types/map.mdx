...
{/* Screenshot: Map-Plot mit einer aus Latitude/Longitude-Signalen geplotteten Trajektorie */}
...
{/* Screenshot: Haus- und Lupen-Symbol oben rechts im Map-Plot */}

## Weitere Einstellungen

Klickt oben rechts im Plot auf das Einstellungsrad, um ihn zu konfigurieren.

{/* Screenshot: Einstellungsrad des Map-Plots */}
