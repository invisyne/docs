...
{/* Screenshot: Min- und Max-Limit für ein Signal festlegen */}
...
{/* Screenshot: Drag-Handles zum Verschieben einer Signalgruppe */}
...
{/* Screenshot: Button "Stack All Signals" in der oberen Leiste */}

Nach dem Klick auf **Stack All Signals** werden die Signale im Plot übereinander gestapelt.

{/* Screenshot: übereinander gestapelte Signale nach Klick auf "Stack All Signals" */}
...
{/* Screenshot: mehrere ausgewählte Signale zu einer Signalgruppe verknüpfen */}
