...
Hier ein Beispiel, das ein diskretes Signal `state_code` in ein Text-Signal `state_name` umwandelt (PostgreSQL-Syntax — siehe [Custom functions](/de/deepview/functions/custom-functions)):
