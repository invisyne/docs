...
Ein Beispiel: Gruppiert nach dem Signal `m.lap`.

![](../../../../../../assets/images/deepview/deepview-analysis-plot-types-aggregates-4.png)

Ist das Aggregate-Format ein Balkendiagramm und das Aggregat der Durchschnitt der Motortemperatur (`avg(m.engine.temperature)`), erhaltet ihr ein Balkendiagramm mit der Verteilung der durchschnittlichen Motortemperatur pro Zyklus.
...
Ihr erhaltet folgendes Balkendiagramm.
