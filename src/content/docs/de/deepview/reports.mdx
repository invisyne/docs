...
2. Wählt **Start Blank**.
3. Gebt dem Template einen **Namen** und optional eine Beschreibung.
4. Legt einen **Dataset-Metadata-Filter** fest, um einzugrenzen, für welche Datensätze das Template gedacht ist.
5. Wählt einen **Referenz-Datensatz**, um Plots in der Vorschau zu sehen und ein Test-PDF zu generieren, während ihr am Layout arbeitet.
6. Wechselt zum **Layout**-Tab, um den Report aufzubauen.
...
1. Klickt im Reports-Tab auf **New report template**.
2. Wählt rechts ein **Projekt** und einen **Referenz-Datensatz**.
3. Wählt aus, welche Tabs und Plots übernommen werden sollen.
4. Legt einen **Dataset-Metadata-Filter** fest, um einzugrenzen, für welche Datensätze das Template gedacht ist.
5. Seht im **Layout**-Tab nach, was erzeugt wurde, und passt den Report an.

{/* Screenshot: Report-Template aus einem bestehenden Projekt erstellen */}
