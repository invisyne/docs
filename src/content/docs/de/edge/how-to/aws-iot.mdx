...
<ol>
  ...
  <li><span>Beim Zertifikats-Schritt <strong>Auto-generate a new certificate (recommended)</strong> auswählen. Nach der Erstellung alle Dateien sofort herunterladen — der private Schlüssel kann danach nicht erneut heruntergeladen werden. Folgende Dateien sichern:</span><ul>
      <li><code>*-certificate.pem.crt</code> — das Gerätezertifikat</li>
      <li><code>*-private.pem.key</code> — der private Schlüssel</li>
      <li><code>AmazonRootCA1.pem</code> — das AWS Root-CA-Zertifikat (Download-Link im Erstellungsdialog)</li>
    </ul></li>
