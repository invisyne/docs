...
<ol>
  ...
  <li><span>Beim Zertifikats-Schritt <strong>Auto-generate a new certificate (recommended)</strong> auswählen. Nach der Erstellung alle Dateien sofort herunterladen — der private Schlüssel kann danach nicht erneut heruntergeladen werden. Folgende Dateien sichern:</span>
    <ul>
