...
Slotnummer und Gestellnummer können in der Hardwarekonfiguration des Projekts nachgeschlagen werden. Die Hardwarekonfiguration im **TIA Portal** öffnen (oder im **SIMATIC Manager** bei S7-300/400-Projekten) und die CPU bzw. den Kommunikationsprozessor in der Rack-Ansicht lokalisieren. Eine Schritt-für-Schritt-Anleitung ist unter [TIA Portal &amp; SIMATIC Manager](/de/edge/field-devices/tia-portal) beschrieben.
