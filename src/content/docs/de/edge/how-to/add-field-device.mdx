...
Slotnummer und Gestellnummer können in der Hardwarekonfiguration des Projekts nachgeschlagen werden. Die Hardwarekonfiguration im **TIA Portal** öffnen (oder im **SIMATIC Manager** bei S7-300/400-Projekten) und die CPU bzw. den Kommunikationsprozessor in der Rack-Ansicht lokalisieren. Eine Schritt-für-Schritt-Anleitung ist unter [TIA Portal](/de/edge/field-devices/tia-portal) oder [SIMATIC Manager](/de/edge/field-devices/simatic-manager) beschrieben.

Für die TIA-Portal-seitige Konfiguration bei absoluter Adressierung (PUT/GET-Kommunikation aktivieren, optimierten Bausteinzugriff deaktivieren) siehe [TIA Portal](/de/edge/field-devices/tia-portal).
