...
3. Es wird nach einem Kennwort gefragt. Diesen muss aktuell ein vordefiniertes sein, welches vom Edge-Endpoint erwartet wird. (Passwort ist beim Kundensupport anzufragen).
...
1. Um Edge-UI navigieren zu: “System > Einstellungen” → Gateway → gewünschten Endpoint 
