...
import certSecurityTab from '../../../../../assets/images/edge/edge-cert-security-tab.png';
...
2. Zu **Einstellungen** → **Netzwerkadapter** wechseln und den Tab **Sicherheit** öffnen.
   ...
   <div class="screenshot-frame"><img src={certSecurityTab.src} alt="Tab Sicherheit: Informationen zum aktuellen Zertifikat und Formular für das eigene Zertifikat" /></div>
...
:::tip
Um jederzeit zum integrierten selbstsignierten Zertifikat des Geräts zurückzukehren, öffnen Sie denselben Tab **Sicherheit** und klicken auf **Zurücksetzen** neben der Überschrift **Aktuelles Zertifikat** — dadurch wird das hochgeladene Zertifikat entfernt.
:::
