...
1. Unter **Rollen** die **OPC-Rule** anlegen und ihr das Recht **OPC UA-Server-Zugriff** zuweisen.

<div class="screenshot-frame">
  <img src={opcRoleRightsImg.src} alt="TIA Portal — Rollen: OPC-Rule mit zugewiesenem Recht OPC UA-Server-Zugriff" />
</div>

2. Unter **Benutzer** einen neuen Benutzer anlegen, ein Passwort vergeben und die **OPC-Rule** zuweisen. Den Benutzer **Anonymous** dabei deaktivieren oder entfernen — nur so ist der Passwortschutz wirksam.
