...
description: "Die Crawler.Companion-Software ist ein intuitives Werkzeug, das die lokale Verwaltung Ihrer Edge-Geräte erleichtert."
---

Die Crawler.Companion-Software ist ein intuitives Werkzeug, das die lokale Verwaltung Ihrer Edge-Geräte erleichtert. Nachfolgend finden Sie eine Beschreibung der Hauptfunktionen anhand der Benutzeroberfläche der Anwendung.

# **Oberflächen-Übersicht und Geräteerkennung**

- **Geräte sofort finden:** Nach dem Start der Anwendung werden alle im lokalen Netzwerk gefundenen Edge-Geräte automatisch in der zentralen Tabelle aufgelistet.
