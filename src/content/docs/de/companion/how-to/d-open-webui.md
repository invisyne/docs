...
description: "Die WebUI (Web User Interface) ist die browserbasierte Oberfläche des Edge (Crawler)-Geräts."
---

Die WebUI (Web User Interface) ist die browserbasierte Oberfläche des Edge (Crawler)-Geräts.
