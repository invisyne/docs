...
{/* Screenshot: "Show History" dialog with previously loaded data sets */}

If you'd like to open a project empty, click **Open empty** in the recent projects list.

{/* Screenshot: "Open empty" button in the recent projects list */}
...
{/* Screenshot: "Read-Only" toggle when saving a project */}
