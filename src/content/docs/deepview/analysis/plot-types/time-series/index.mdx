...
{/* Screenshot: Time Series plot with signal panel on the left, signals grouped by color */}
...
{/* Screenshot: selected signal group with grey background and continuous line */}
