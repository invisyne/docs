...
{/* Screenshot: multiple data sets chained end-to-end on the time axis */}
...
{/* Screenshot: Organise datasets dialog in Chain mode with reorder arrows */}
...
{/* Screenshot: time axis offset settings for chained data sets */}
